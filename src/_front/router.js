...
window.wwg_designInfo.pages = window.wwg_designInfo.pages.map(page =>
    page.metaImage === 'images/luxury_pack_edited.png?_wwcv=6' ? { ...page, metaImage: SOCIAL_IMAGE_PATH } : page
);
